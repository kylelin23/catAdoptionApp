...
const faqs: FAQ[] = [
    {
        question: 'Should I adopt one or more cats? Will one cat be lonely?',
        answer: "It all depends! Many households start out with one cat and add a second cat later while some find out that their cat may prefer to be the only cat."
    },
    ...
    {
        question: 'Can a cat be around babies and little kids?',
        answer: "Yes! But just as you won't leave a young child alone, interactions between little kids and cats should be supervised. It's a great opportunity to teach them how to handle cats gently and lovingly."
    },

    {
        question: 'Will they scratch up my furniture?',
        answer: 'Cats scratch for a reason! They do it to sharpen their claws, mark their territory or perhaps out of boredom. Provide scratching posts and gently deter them from scratching. Declawing is inhumane and should not be done.'
    },
    ...
    {
        question: "What if my current pet can't get along with the new cat?",
        answer: "Expect time for the transition. But if you're worried about whether the cats will get along, introducing kittens are generally an easier transition."
    },
