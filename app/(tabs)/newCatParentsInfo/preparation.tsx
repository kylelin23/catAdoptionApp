    ...
    <View style={styles.container}>
      ...
      <View style={styles.topArea}>
        ...
        <View style={styles.titleRow}>
          ...
          <View style={styles.counterBadge}>
            ...
            <Text style={styles.counterBadgeDenom}>/{prepCards.length}</Text>
          </View>
        </View>
      </View>
      ...
      <View style={styles.bottomArea}>
        ...
        <View style={styles.navRow}>
          ...
          <TouchableOpacity
            style={[styles.navButton, styles.navButtonNext, currentIndex === prepCards.length - 1 && styles.navButtonDisabled]}
