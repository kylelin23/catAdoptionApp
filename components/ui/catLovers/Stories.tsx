...
const styles = StyleSheet.create({
  ...
  successText: { fontFamily: 'Avenir', fontSize: 16, fontWeight: '800', color: GREEN, textAlign: 'center' },
  ...
  sharePromptTitle: { fontFamily: 'Avenir', fontSize: 16, fontWeight: '900', color: INK },
  sharePromptSub: { fontFamily: 'Avenir', fontSize: 13, fontWeight: '400', color: INK_SOFT },
  ...
  emptyText: { fontFamily: 'Avenir', fontSize: 14, fontWeight: '400', color: INK_SOFT, textAlign: 'center' },
  ...
  storyName: { fontFamily: 'Avenir', fontSize: 16, fontWeight: '900', color: INK },
  storyCatBadge: { fontFamily: 'Avenir', fontSize: 13, fontWeight: '400', color: INK_SOFT },
  ...
  storyPreview: { fontFamily: 'Avenir', fontSize: 14, fontWeight: '400', color: INK_SOFT, lineHeight: 20 },
  ...
  storySectionText: { fontFamily: 'Avenir', fontSize: 14, fontWeight: '400', color: INK_SOFT, lineHeight: 20 },
  bestPartSection: { backgroundColor: 'rgba(123,174,110,0.08)', borderWidth: 1.5, borderColor: 'rgba(123,174,110,0.3)' },
  bestPartText: { fontFamily: 'Avenir', fontSize: 15, fontWeight: '700', color: INK, lineHeight: 22, fontStyle: 'italic' },
  ...
  modalTitle: { fontFamily: 'Avenir', fontSize: 22, fontWeight: '900', color: INK, letterSpacing: -0.3 },
  modalSub: { fontFamily: 'Avenir', fontSize: 14, fontWeight: '400', color: INK_SOFT, marginTop: 2 },
